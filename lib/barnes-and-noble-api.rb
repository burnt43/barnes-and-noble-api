...
module BanApi
  ...
  module Parsers
    ...
    class Search
      ...
      # TODO: Complete this method by parsing out the data into the Product
      # class.
      def products
        product_nodes = @document.css("div.product-shelf-info.product-info-view")
        product_nodes.each_with_index do |product_node, index|
          a_nodes = product_node.css('a')

          if index == 0
            puts a_nodes[0]['title']
          end
        end
      end
    end
